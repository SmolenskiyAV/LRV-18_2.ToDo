        ...
        <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
            <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
                ...
                <div style="box-sizing: border-box; margin-left: 5px">
                    ...
                    <div>
                        <span class="fs-4" style="font-size: small">LRV-18_2.ToDo</span>
                    </div>
                </div>
            </a>
            ...
            <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                ...
                <a class="me-3 py-2 text-dark text-decoration-none" href="{{route('list')}}">Список задач</a>
                <a class="me-3 py-2 text-dark text-decoration-none" href="{{route('create')}}">Создать задачу</a>
            </nav>
    </div>
